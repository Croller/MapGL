...
(function(ThreeDxf) {
    ...
    ThreeDxf.Viewer = function(data, parent, width, height, font) {
        ...
        console.log(data);
        var viewports = data.tables.viewPort.viewPorts;
        if(viewports !== undefined && viewports.length > 0){
            if( viewports[0].center !== undefined ){
                center.x = viewports[0].center.x;
                center.y = viewports[0].center.y;
                if( viewports[0].center.z !== undefined ) center.z = viewports[0].center.z;
            }
        }
        ...
        try
            ...
            for(let i = 0; i < data.entities.length; i++) {
                ...
                //console.log(entity.type, i, Math.round( i/data.entities.length*100 ));
                ...
                if(obj) {
                    ...
                    if( entity.handle !== undefined ) obj.name += entity.handle;
                    if( entity.layer !== undefined ) obj.name += " "+entity.layer;
    ...
    //     // var camera = new THREE.OrthographicCamera(viewPort.left, viewPort.right, viewPort.top, viewPort.bottom, 0, 20000);
    ...
    //     };
        ...
        function drawLine(entity, data) {
            ...
            for(let i = 0; i < entity.vertices.length; i++) {
                if(entity.vertices[i].bulge) {
                    ...
                    vertices.push(new THREE.Vector2(vertex.x, vertex.y));
            ...
            if(entity.shape){
                ...
                material = new THREE.MeshStandardMaterial({ color: color, roughness: 0.75 });
                
                geometry.copy( shapeGeometry );
        ...
        function drawCircle(entity, data) {
            ...
            circle.position.x = entity.center.x - center.x;
            circle.position.y = entity.center.y - center.y;
            circle.position.z = entity.center.z - center.z;
        ...
        function drawText(entity, data) {
            ...
            geometry = new THREE.Text2DGeometry(entity.text, { font: font, height: 0, size: entity.textHeight || 12, curveSegments : 2});
            ...
            text.position.x = -(entity.startPoint.x - center.x);
            text.position.y = entity.startPoint.z - center.z;
            text.position.z = entity.startPoint.y - center.y;
        ...
        function drawBlock(entity, data) {
            ...
            if(entity.position) {
                group.position.x = -(entity.position.x - center.x);
                group.position.y = entity.position.z - center.z;
                group.position.z = entity.position.y - center.y;
            }
        ...
        function setGeometry(geometry){
            ...
            for(i = 0; i < geometry.vertices.length; i++) {
                let vertice = {};
                vertice.x = geometry.vertices[i].x - center.x;
                vertice.y = geometry.vertices[i].y - center.y;
                vertice.z = geometry.vertices[i].z - center.z;
                geometry.vertices[i].x = vertice.x;
                geometry.vertices[i].y = vertice.y;
                geometry.vertices[i].z = vertice.z;
